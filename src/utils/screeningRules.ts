...
// Keywords mapping for Qualification Checks (Simple heuristic)
const QUALIFICATION_KEYWORDS: Record<string, string[]> = {
    'Medical Officer': ['MBBS', 'Medicine', 'Surgery', 'Medical'],
    'Pharmacist': ['B.Pharm', 'Pharmacy', 'Pharmaceutical'],
    'Radiographer': ['Radiography', 'Imaging', 'Rad'],
    'Physiotherapist': ['Physiotherapy', 'Rehabilitation', 'BMR'],
    'Medical Laboratory Scientist': ['BMLS', 'Laboratory', 'Science'],
    'Medical Laboratory Technician': ['MLT', 'Technician', 'Laboratory'],
    'Nurse': ['Nursing', 'Curative', 'RN', 'RM', 'Midwifery'],
    'Nursing Officer': ['Nursing', 'BNSc', 'RN', 'RM'],
    'Health Information': ['Health Information', 'Records', 'HIM'],
    'Environmental Health': ['Environmental', 'Health', 'EHO', 'MHT'],
    'Senior Nursing': ['Nursing', 'BNSc', 'RN', 'RM'],
    'Staff Nurse': ['Nursing', 'RN', 'RM'],
};
