            ...
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
                <div>
                    <h2 className="text-2xl font-bold text-[#1e3a5f] flex items-center gap-2">
                        <Printer className="text-brand-teal" /> Manual Slip Generator
                    </h2>
                    <p className="text-gray-500">Create official application slips for offline or manual candidates.</p>
                </div>
            </div>
                    ...
                    <div className="flex justify-end pt-4">
                        ...
                        >
                            {isGenerating ? 'Generating PDF...' : (
                                <>
                                    <FileText size={20} /> Generate & Download Slip
                                </>
                            )}
                        </button>
                    </div>
