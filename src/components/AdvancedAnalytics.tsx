    ...
    const exportPDF = async () => {
        ...
        try {
            ...
            if (pdfHeight > 297) {
                ...
                customPdf.save(`Recruitment_Executive_Report_${new Date().toISOString().split('T')[0]}.pdf`);
            } else {
                pdf.addImage(imgData, 'PNG', 0, 0, pdfWidth, pdfHeight);
                pdf.save(`Recruitment_Executive_Report_${new Date().toISOString().split('T')[0]}.pdf`);
            }
        ...
        <div className="space-y-8">
            ...
            <div className="flex justify-between items-center bg-white p-4 rounded-xl shadow-sm border border-gray-100 no-print">
                <div>
                    ...
                    <p className="text-sm text-gray-500">Recruitment insights & performance metrics</p>
                </div>
                <button
                    onClick={exportPDF}
            ...
            <div ref={reportRef} className="space-y-8 p-8 bg-white min-h-screen text-slate-800">
                ...
                <div className="border-b border-gray-200 pb-6 mb-6">
                    <div className="flex justify-between items-end">
                        <div>
                            <h1 className="text-3xl font-extrabold text-[#1e3a5f] uppercase tracking-wide">Recruitment Status Report</h1>
                ...
                <div className="grid grid-cols-4 gap-4 mb-8">
                    ...
                    <div className="p-4 bg-blue-50 border border-blue-100 rounded-lg">
                        ...
                        <div className="text-xs text-blue-600 mt-1">{stateData[0]?.value} Applicants</div>
                    </div>
                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-8">
                    ...
                    <div className="bg-white border border-gray-100 rounded-xl p-4 shadow-sm">
                        <div className="flex items-center gap-2 mb-4">
                            ...
                            <h3 className="font-bold text-gray-800">Top Applicant States</h3>
                        </div>
                        <div className="h-64">
                            <ResponsiveContainer width="100%" height="100%">
                ...
                <div className="mt-12 break-before-page">
                    ...
                    <div className="mt-8 text-center text-xs text-gray-400">
                        <p>End of Report • Generated via Recruitment Portal Admin</p>
                    </div>
                </div>
            </div>
        </div>
