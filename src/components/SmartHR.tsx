...
interface SmartHRProps {
    applications: any[];
}

export default function SmartHR({ applications }: SmartHRProps) {
    ...
    const handleSmartExport = async () => {
        ...
        try {
            ...
            const summaryData = [
                ['HR Screening Report', new Date().toLocaleString()],
                ['', ''],
            ...
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
                <div>
                    <h2 className="text-2xl font-bold text-[#1e3a5f] flex items-center gap-2">
                        <ShieldCheck className="text-brand-teal" /> Smart HR Assistant
                    </h2>
