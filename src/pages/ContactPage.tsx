          ...
          <div className="space-y-6">
            ...
            <div className="flex items-start gap-4 group">
              ...
              <div>
                ...
                <a href="mailto:recruitment@kiuth.edu.ng" className="text-brand-teal hover:underline">recruitment@kiuth.edu.ng</a>
                <br />
                <a href="mailto:info@kiuth.edu.ng" className="text-brand-teal hover:underline">info@kiuth.edu.ng</a>
              </div>
            </div>
            ...
            <div className="flex items-start gap-4 group">
              ...
              <div>
                ...
                <a href="tel:+2347612345 67" className="text-gray-600 hover:text-brand-teal">+234 (0) 76 123 4567</a>
                <br />
                <a href="tel:+23476123456 8" className="text-gray-600 hover:text-brand-teal">+234 (0) 76 123 4568</a>
              </div>
            </div>
